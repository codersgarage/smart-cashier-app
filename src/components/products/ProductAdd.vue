                                    ...
                                    <div id="form" data-parsley-validate="" novalidate="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <select class="form-control form-control-sm"
                                                            v-on:change="onCheckBoxHandle" name="is_digital">
                                                        <option v-bind:key="'yes'" v-bind:value="'yes'">Yes</option>
                                                        <option v-bind:key="'no'" v-bind:value="'no'" selected>No
                                                        </option>
                                                    </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9 col-lg-10">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <select class="form-control form-control-sm"
                                                            v-on:change="onCheckBoxHandle" name="is_shippable">
                                                        <option v-bind:key="'yes'" v-bind:value="'yes'">Yes</option>
                                                        <option v-bind:key="'no'" v-bind:value="'no'" selected>No
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="col-sm-6 pl-0">
                                                <p class="text-right">
                                                    <button type="submit" class="btn btn-space btn-primary"
                                                            ...
                                                            v-on:click="createNewProduct">Add
                                                    </button>
    ...
    export default {
        ...
        methods: {
            ...
            onCheckBoxHandle: function (e) {
                ...
                } else if (name === 'is_digital') {
                    this.isDigital = value === 'yes';
                } else if (name === 'is_shippable') {
                    this.isShippable = value === 'yes';
                }
            },
            ...
            createNewProduct: function () {
                ...
                axios.post(Settings.GetApiUrl() + "/products", pld, {
                    headers: {
                        "Authorization": "Bearer " + SessionStore.GetAccessToken(),
                    }
                }).then(resp => {
